...
export class Context {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (key) {
                if (this._sharedKey) {
                    ...
                    const material = yield importKey(key);
                    newKey = yield deriveKeys(material);
                }
            }
    ...
    encodeFunction(encodedFrame, controller) {
        ...
        if (this._cryptoKeyRing[keyIndex]) {
            ...
            }, this._cryptoKeyRing[keyIndex].encryptionKey, new Uint8Array(encodedFrame.data, UNENCRYPTED_BYTES[encodedFrame.type]))
                .then(cipherText => {
